...
// Xac minh do tuoi cua nguoi xem
let title = $('title')
let btnEnter = $('.btn-enter')
let btnCancel = $('.btn-cancel');
let webQuestion = $('#web-question');
function handleVerifyYear(){
	title.innerText = 'Xác minh độ tuổi';
	btnEnter.addEventListener('click', ()=> {
		webQuestion.classList.add('close');
		renderWebsite()
	})
	btnCancel.addEventListener('click', () => {
		alert('Xin lỗi bạn không đủ điều kiện để đăng nhập Website "=<"')
	})
}; handleVerifyYear()
